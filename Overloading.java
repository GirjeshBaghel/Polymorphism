//Write a program by using method overloadind.Calculate ACir Arec Acyl ASqu ATri
...
public class Overloading 
{
		...
		static int r,l,b,h,side,x,y;
		static double a,c ,pie=3.14;
		...
		{
			System.out.println("calculate the area of Triangle = 1/2(b*h) ");// let x=b,y=h
